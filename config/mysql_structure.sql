...
ALTER TABLE `categories_words`
  ADD CONSTRAINT `categories_words_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `documents_words`
  ADD CONSTRAINT `documents_words_ibfk_2` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE,
