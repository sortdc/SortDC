...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            classifier.train("text8", "L'affaire DSK fait beaucoup parler d'elle en ce moment. Le Parti Socialiste enrage.", "politique");
            classifier.train("text9", "Martine Aubry saute sur l'occasion pour prendre la tête des primaires au sein du Parti Socialiste.", "politique");
            ...
            System.out.println("Catégorisation 3 (Parti pirate) : " + classifier.categorize("Le parti Pirate est encore très peu présent en France. Il soutient les logiciels libres."));
        } catch (Exception e) {
            Log.getInstance().add(e);
        }
    }
